        ...
        children: [
          ...
          CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(child: _FeaturedCard(stream: featured, isLarge: true)),
              SliverPadding(
                padding: const EdgeInsets.fromLTRB(16, 0, 16, 100),
                sliver: SliverGrid(
                  delegate: SliverChildBuilderDelegate((context, i) => _FeaturedCard(stream: grid[i], isLarge: false), childCount: grid.length),
          ...
          Positioned(right: 16, bottom: kBottomNavigationBarHeight + 40, child: _GoLiveFab()),
        ],
      ),
    );
  }
        ...
        itemBuilder: (context, i) {
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(color: isActive ? AppColors.white : AppColors.card, borderRadius: BorderRadius.circular(20)),
              child: Text(
                _tabs[i],
                style: TextStyle(color: isActive ? Colors.black : AppColors.textSecondary, fontSize: 12, fontWeight: FontWeight.w600),
              ),
            ),
          );
        },
...
class _FeaturedCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(builder: (_) => LiveDetailPage(stream: stream)));
      },
      child: Container(
        margin: isLarge ? const EdgeInsets.fromLTRB(16, 0, 16, 12) : EdgeInsets.zero,
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: [Color(stream.gradientStart), Color(stream.gradientEnd)],
          ),
        ),
        child: Stack(
          children: [
            // LIVE badge
            Positioned(top: 9, left: 9, child: _LiveBadge()),

            // Viewer count
            Positioned(top: 9, right: 9, child: _ViewerCount(count: stream.viewerCount)),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(color: const Color(0xFF555555), shape: BoxShape.circle),
                          alignment: Alignment.center,
                          child: Text(
                            stream.initials,
                            style: TextStyle(color: Colors.white, fontSize: isLarge ? 9 : 7, fontWeight: FontWeight.w800),
                          ),
                        ),
                        const SizedBox(width: 6),
                        Text(
                          stream.creator,
                          style: TextStyle(color: Colors.white, fontSize: isLarge ? 12 : 10, fontWeight: FontWeight.w600),
                        ),
                      ],
                    ),
                    ...
                    Text(
                      stream.title,
                      style: TextStyle(color: Colors.white, fontSize: isLarge ? 13 : 11, fontWeight: FontWeight.w600),
                      maxLines: 1,
...
class _LiveBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: AppColors.liveBadge, borderRadius: BorderRadius.circular(5)),
      child: const Row(
        mainAxisSize: MainAxisSize.min,
        children: [
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          const Icon(Icons.remove_red_eye_outlined, color: Colors.white, size: 10),
...
class _GoLiveFabState extends State<_GoLiveFab> with SingleTickerProviderStateMixin {
  ...
  void _showSheet(BuildContext context) {
    showModalBottomSheet(context: context, backgroundColor: Colors.transparent, isScrollControlled: true, builder: (_) => const _LiveBottomSheet());
  }
    ...
    return GestureDetector(
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) => Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(colors: [AppColors.accent, Color(0xFFC0185A)], begin: Alignment.topLeft, end: Alignment.bottomRight),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'LIVE STREAM',
            style: TextStyle(color: AppColors.textSecondary, fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 2),
          ),
          const SizedBox(height: 20),
          ...
          _SheetOption(
            ...
            onTap: () {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (_) => const LivePage(role: RoomRole.host)));
            },
          ),
          ...
          _SheetOption(
            ...
            onTap: () {
              Navigator.pop(context);
              Navigator.push(context, MaterialPageRoute(builder: (_) => const LivePage(role: RoomRole.viewer)));
            },
          ),
          ...
          Row(
            ...
            children: [
              ...
              const Text('Powered by LiveKit · real-time WebRTC', style: TextStyle(color: AppColors.textSecondary, fontSize: 11)),
            ],
          ),
        ],
      ),
...
class _SheetOption extends StatelessWidget {
  const _SheetOption({required this.icon, required this.iconGradient, required this.title, required this.subtitle, required this.onTap});
